...
public class DrawerActivity extends AppCompatActivity {
    ...
    private void loginWithLinkedIn() {
         ...
         * LinkedInLoginWebViewActivity.class);
     ...
     * LoginManager.getInstance().logInWithReadPermissions(DrawerActivity.this,
     ...
     * , str_lastname, "https://graph.facebook.com/" + str_id +
     * "/picture?type=normal", "f", str_id);
     * } catch (JSONException e) {
     ...
     * Toast.makeText(DrawerActivity.this, R.string.signup_with_email,
                        ...
                        if (status) {
                            ...
                            if (resultObj.isStatus()) {
                                ...
                                if (loginData.getUserType().equals("")) {
                                    ...
                                    PrefsUtil.with(DrawerActivity.this).write("CurrencySign",
                                            loginData.getCurrencySign());
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            // if (!(TextUtils.isEmpty(acct.getGivenName())) &&
            // !(Objects.requireNonNull(acct.getGivenName()).equalsIgnoreCase("null")) &&
            // (acct.getGivenName() != null)) {
            // } else {
            // loginWithGooglePlus();
            // }
                ...
                new WebServiceCall.OnResultListener() {
                    ...
                    public void onResult(boolean status, Object obj) {
                        ...
                        if (status) {
                            ...
                            binding.txtUsercontactno.setText(response_profile.getData().getCountryCode() + " "
                                    + response_profile.getData().getContactNumber());
                            if (!response_profile.getData().getAvailableTimeStart().equals("")) {
                                binding.txtServicetime.setText(response_profile.getData().getAvailableTimeStart()
                                        + " - " + response_profile.getData().getAvailableTimeEnd());
                            } else {
                            ...
                            PrefsUtil.with(context).write("userContactno",
                                    response_profile.getData().getContactNumber());
                            ...
                            PrefsUtil.with(context).write("total_rating",
                                    response_profile.getData().getPositiveRating());
                            ...
                            PrefsUtil.with(context).write("start_time",
                                    response_profile.getData().getAvailableTimeStart());
    ...
    public void onBackPressed() {
        ...
        builder.setMessage("Are you sure you want to exit app?")
                ...
                .setNegativeButton("No", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        dialogInterface.cancel();
                        // Call super to allow default back behavior if needed
    ...
    private void getOfflineUserDetails() {
        try {
            ...
            binding.txtUsercontactno.setText(String.format("%s %s", response_profile.getData().getCountryCode(),
                    response_profile.getData().getContactNumber()));
            if (!response_profile.getData().getAvailableTimeStart().equals("")) {
                binding.txtServicetime
                        .setText(String.format("%s - %s", response_profile.getData().getAvailableTimeStart(),
                                response_profile.getData().getAvailableTimeEnd()));
            } else {
                binding.txtServicetime.setText("N/A");
            }
