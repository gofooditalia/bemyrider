...
public class TempStripe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_stripe);
...
//                + "}";
    ...
    private static final class PayCallback implements Callback {
        @NonNull
        private final WeakReference<TempStripe> activityRef;
        PayCallback(@NonNull TempStripe activity) {
            activityRef = new WeakReference<>(activity);
        }
        @Override
        public void onFailure(@NonNull Call call, @NonNull IOException e) {
            progressDialog.dismiss();
            final TempStripe activity = activityRef.get();
            if (activity == null) {
                return;
            }
    ...
    private void onPaymentSuccess(@NonNull final Response response) throws IOException {
        ...
        if (params != null) {
            ...
            //start payment
            stripe.confirmPayment(TempStripe.this, confirmParams);
        }
    ...
    private final class PaymentResultCallback
        ...
        @NonNull private final WeakReference<TempStripe> activityRef;
        PaymentResultCallback(@NonNull TempStripe activity) {
            activityRef = new WeakReference<>(activity);
        }
