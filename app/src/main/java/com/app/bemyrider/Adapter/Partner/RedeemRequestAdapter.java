...
public class RedeemRequestAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_ITEM) {
            ...
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.redeem_request_history_new, parent, false);
            return new ViewHolderItem(view);
        } /*else if (viewType == TYPE_HEADER) {
            //inflate your layout and pass it to view holder
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.redeem_history_header, parent, false);
        ...
        if (holder instanceof ViewHolderHeader) {
            ...
            ((ViewHolderItem)holder).imgInfo.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    txtRequestAmount.setText(arrayList.get(position).getRequestedAmount());
                    txtAdminFees.setText(arrayList.get(position).getAdminFees());
                    txtRequestDate.setText(arrayList.get(position).getRequestedDate());
                    txtRedeemDate.setText(arrayList.get(position).getRedeemedDate());
                    txtRedeemAmount.setText(arrayList.get(position).getRedeemedAmount());
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        holder.txt_request_amount_redeem.setText(arrayList.get(position).getRedeemedAmount());
        ...
        holder.txt_redeem_amount_redeem.setText(arrayList.get(position).getRequestedAmount());
        holder.txt_requested_date_redeem.setText(arrayList.get(position).getRequestedDate());
    }*/
...
*/
    ...
    public class ViewHolderHeader extends RecyclerView.ViewHolder {
        ...
        private TextView txt_request_amount_redeem, txt_admin_fees_redeem, txt_requested_date_redeem, txt_redeem_amount_redeem, txt_redeem_date_redeem;
