...
public class RvPreviousServiceRequestAdapter extends RecyclerView.Adapter<RvPreviousServiceRequestAdapter.Holder> {

    private Context context;
    private ArrayList<ProviderHistoryPojoItem> arrayList;

    public RvPreviousServiceRequestAdapter(Context context, ArrayList<ProviderHistoryPojoItem> arrayList) {
