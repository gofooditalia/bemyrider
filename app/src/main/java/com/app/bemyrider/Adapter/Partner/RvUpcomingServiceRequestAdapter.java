...
public class RvUpcomingServiceRequestAdapter extends RecyclerView.Adapter<RvUpcomingServiceRequestAdapter.Holder> {

    private Context context;
    private ArrayList<ProviderHistoryPojoItem> arrayList;

    public RvUpcomingServiceRequestAdapter(Context context, ArrayList<ProviderHistoryPojoItem> arrayList) {
