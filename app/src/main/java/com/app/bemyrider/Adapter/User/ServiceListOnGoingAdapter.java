...
public class ServiceListOnGoingAdapter extends RecyclerView.Adapter<ServiceListOnGoingAdapter.MyViewHolder> {

    private List<CustomerHistoryPojoItem> historyList;
    private Activity act;

    public ServiceListOnGoingAdapter(Activity act, List<CustomerHistoryPojoItem> historyList) {
        this.act = act;
