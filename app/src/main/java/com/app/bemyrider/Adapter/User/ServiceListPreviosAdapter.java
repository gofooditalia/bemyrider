...
public class ServiceListPreviosAdapter extends RecyclerView.Adapter<ServiceListPreviosAdapter.MyViewHolder> {

    private List<CustomerHistoryPojoItem> historyList;
    private Activity act;

    public ServiceListPreviosAdapter(Activity act, List<CustomerHistoryPojoItem> historyList) {
        this.act = act;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            txtProviderName = (TextView) view.findViewById(R.id.txtProviderName);
