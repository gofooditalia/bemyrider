...
public class PaymentHistoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private ArrayList<TransectionListItem> arrayList;
    private Context context;

    public PaymentHistoryAdapter(ArrayList<TransectionListItem> arrayList, Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_ITEM) {
            ...
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.deposit_history_item_new,parent,false);
            return new ViewHolderItem(view);
        } /*else if (viewType == TYPE_HEADER) {
            //inflate your layout and pass it to view holder
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.deposit_history_header,parent,false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof PaymentHistoryAdapter.ViewHolderHeader) {
            //cast holder to VHItem and set data
        } else if (holder instanceof PaymentHistoryAdapter.ViewHolderItem) {
            //cast holder to VHHeader and set data for header.
            ((PaymentHistoryAdapter.ViewHolderItem)holder).txt_admin_fees_deposit.setText(arrayList.get(position).getAdminFees());
            ((PaymentHistoryAdapter.ViewHolderItem)holder).txt_amount_deposit.setText(arrayList.get(position).getAmount());
            ((PaymentHistoryAdapter.ViewHolderItem)holder).txt_date_deposit.setText(arrayList.get(position).getDate());
            ((PaymentHistoryAdapter.ViewHolderItem)holder).txt_transaction_id_deposit.setText(arrayList.get(position).getTransactionId());


            ((PaymentHistoryAdapter.ViewHolderItem)holder).imgInfo.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ...
                    txtAmount.setText(arrayList.get(position).getAmount());
                    txtAdminFees.setText(arrayList.get(position).getAdminFees());
                    txtDate.setText(arrayList.get(position).getDate());
                    txtTransactionId.setText(arrayList.get(position).getTransactionId());
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.txt_transaction_id_deposit.setText(arrayList.get(position).getTransactionId());
    }*/
