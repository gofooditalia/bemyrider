...
public class PaymentHistoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof PaymentHistoryAdapter.ViewHolderHeader) {
            ...
            ((PaymentHistoryAdapter.ViewHolderItem) holder).txt_admin_fees_deposit
                    .setText(arrayList.get(position).getAdminFees());
            ((PaymentHistoryAdapter.ViewHolderItem) holder).txt_amount_deposit
                    .setText(arrayList.get(position).getAmount());
            ((PaymentHistoryAdapter.ViewHolderItem) holder).txt_date_deposit.setText(arrayList.get(position).getDate());
            ((PaymentHistoryAdapter.ViewHolderItem) holder).txt_transaction_id_deposit
                    .setText(arrayList.get(position).getTransactionId());
